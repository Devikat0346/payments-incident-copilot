...
import { useLiveCases } from "@/lib/useLiveCases";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen px-6 py-10 md:px-12 lg:px-20 max-w-[1000px] mx-auto">
      <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-8">
        <div>
          ...
          <p className="text-secondary text-sm mt-1">
            Watches the payments observability platform&apos;s live telemetry, and uses Claude to
      ...
      <section className="flex flex-col gap-4">
        {cases.length === 0 && (
          <div className="card p-8 text-center text-muted text-sm">
            ...
            Check back shortly; the upstream simulator injects incidents periodically.
          </div>
        )}
        {cases.map((c) => (
